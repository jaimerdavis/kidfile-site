      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10 grid md:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left mt-12 md:mt-0">
          ...
          <div className="hero-element flex flex-col sm:flex-row items-center md:items-start w-full gap-3 md:gap-4 mt-2">
            <a href="#app-store" className="flex items-center justify-center gap-3 bg-deep-navy text-white px-5 py-3 md:px-6 md:py-3.5 rounded-[1.25rem] font-sans btn-spring shadow-soft w-[85%] sm:w-auto hover:bg-[#152042] transition-colors border border-deep-navy/10">
              <svg className="w-6 h-6 md:w-7 md:h-7 pb-[1px] ml-0.5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="#google-play" className="flex items-center justify-center gap-3 bg-deep-navy text-white px-5 py-3 md:px-6 md:py-3.5 rounded-[1.25rem] font-sans btn-spring shadow-soft w-[85%] sm:w-auto hover:bg-[#152042] transition-colors border border-deep-navy/10">
              <svg className="w-6 h-6 md:w-7 md:h-7 ml-1" viewBox="0 0 24 24" fill="currentColor">
