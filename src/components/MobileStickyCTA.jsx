  ...
  return (
    ...
    >
      <div className="bg-warm-white/85 backdrop-blur-xl border-t border-soft-sand px-4 pt-4 pb-6 shadow-[0_-10px_40px_rgba(28,43,89,0.08)] flex justify-center gap-3">
        <a 
          href="#app-store" 
          className="flex-1 flex items-center justify-center gap-2 bg-deep-navy text-white font-bold font-sans py-3.5 rounded-2xl shadow-md active:scale-[0.98] transition-transform"
        >
