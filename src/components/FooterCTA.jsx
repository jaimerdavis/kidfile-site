        ...
        <div className="text-center max-w-4xl mx-auto relative z-10">
          ...
          <div className="flex justify-center w-full mt-4">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
              <a href="#app-store" onClick={(e) => { e.preventDefault(); e.currentTarget.focus(); }} className="group relative overflow-hidden flex items-center justify-center gap-3 bg-white text-deep-navy px-6 md:px-8 rounded-[1.5rem] font-sans btn-spring shadow-xl w-[85%] sm:w-[200px] md:w-[230px] h-[60px] md:h-[72px] hover:bg-cloud transition-colors focus:outline-none">
                <div className="flex items-center justify-center gap-3 transition-opacity duration-200 group-hover:opacity-0 group-focus:opacity-0 group-active:opacity-0">
                  <svg className="w-7 h-7 md:w-8 md:h-8 pb-[1px] ml-0.5 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="#google-play" onClick={(e) => { e.preventDefault(); e.currentTarget.focus(); }} className="group relative overflow-hidden flex items-center justify-center gap-3 bg-white text-deep-navy px-6 md:px-8 rounded-[1.5rem] font-sans btn-spring shadow-xl w-[85%] sm:w-[200px] md:w-[230px] h-[60px] md:h-[72px] hover:bg-cloud transition-colors focus:outline-none">
                <div className="flex items-center justify-center gap-3 transition-opacity duration-200 group-hover:opacity-0 group-focus:opacity-0 group-active:opacity-0">
                  <svg className="w-7 h-7 md:w-8 md:h-8 ml-1 text-[#333] flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
