        ...
        <div className="text-center max-w-4xl mx-auto relative z-10">
          ...
          <div className="flex justify-center w-full mt-4">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
              <a href="#app-store" className="flex items-center justify-center gap-3 bg-white text-deep-navy px-6 py-3.5 md:px-8 md:py-4 rounded-[1.5rem] font-sans btn-spring shadow-xl w-[85%] sm:w-auto hover:bg-cloud transition-colors">
              ...
              <a href="#google-play" className="flex items-center justify-center gap-3 bg-white text-deep-navy px-6 py-3.5 md:px-8 md:py-4 rounded-[1.5rem] font-sans btn-spring shadow-xl w-[85%] sm:w-auto hover:bg-cloud transition-colors">
